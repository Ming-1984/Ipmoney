...
export class ArtworksService {
  ...
  async create(req: any, body: any) {
    ...
    const hasSize = this.hasOwn(body, 'size');
    ...
    const size = hasSize ? this.parseNullableNonEmptyStringStrict(body?.size, 'size') : null;
  ...
  async update(req: any, artworkId: string, body: any) {
    ...
    const size = hasSize ? this.parseNullableNonEmptyStringStrict(body?.size, 'size') : undefined;
