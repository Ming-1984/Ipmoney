...
export default function PatentMapPage() {
  ...
  const handleRetry = useCallback(() => {
    ...
    void loadSummary(year);
  }, [year, yearsError, loadYears, loadSummary]);
              ...
              <Surface>
                ...
                <Button
                  ...
                  onClick={() => {
                    ...
                    Taro.navigateTo({
                      url: `/subpackages/patent-map/region-detail/index?regionCode=${selectedRegion.regionCode}&year=${targetYear}`,
                    });
                  }}
                >
                    查看详情
              ...
              {summary.map((it, idx) => (
                <CellRow
                  ...
                  onClick={() => {
                    const targetYear = year ?? new Date().getFullYear();
                    Taro.navigateTo({
                      url: `/subpackages/patent-map/region-detail/index?regionCode=${it.regionCode}&year=${targetYear}`,
                    });
                  }}
                />
              ))}
