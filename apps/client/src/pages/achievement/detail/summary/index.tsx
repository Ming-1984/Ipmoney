...
export default function AchievementDetailSummaryPage() {
  ...
  const summaryText = data?.summary || data?.description || '暂无摘要';
  ...
  return (
    <View className="container detail-page-compact has-sticky">
      <PageHeader weapp back title="成果详情" subtitle="摘要内容" />
      <Spacer />
        ...
        <View>
          ...
          <View className="patent-card-stack">
            ...
            <Surface className="detail-section-card">
              <Text className="patent-summary-text">{summaryText}</Text>
            </Surface>
          </View>
