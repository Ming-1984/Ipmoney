...
export default function AboutPage() {
  ...
  return (
    <View className="container settings-page">
      <PageHeader weapp back title="关于与合规" subtitle="隐私与用户服务协议" />
      <Spacer />

      <Surface className="settings-card">
        <Cell title="隐私政策" extra="查看" onClick={() => Taro.navigateTo({ url: '/subpackages/legal/privacy/index' })} />
        <Cell title="用户服务协议" extra="查看" onClick={() => Taro.navigateTo({ url: '/subpackages/legal/terms/index' })} />
      ...
      <Surface className="settings-card">
        <Cell
          ...
          onClick={() =>
            Taro.showModal({
              title: '平台介绍',
              content: '平台为知识产权、专利及成果相关的信息展示、咨询、交易协同、合同与风控服务提供支持。',
              showCancel: false,
            })
          }
        />
      ...
      <Surface className="settings-tip">
        <Text className="settings-tip-text">如需进一步了解隐私、协议与合规处理方式，请查看相关说明或联系平台客服。</Text>
      </Surface>
    </View>
  );
}
