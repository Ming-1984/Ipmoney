          ...
          <View
            ...
            onClick={() => {
              ...
              if (t.type === 'PERSON') {
                ...
                Taro.navigateTo({
                  url: `/subpackages/profile/edit/index?from=login&verifyType=PERSON&nextType=switchTab&nextUrl=${encodeURIComponent(
                    '/pages/me/index',
                  )}`,
                });
                return;
              ...
              Taro.navigateTo({ url: '/subpackages/onboarding/verification-form/index' });
            }}
          >
