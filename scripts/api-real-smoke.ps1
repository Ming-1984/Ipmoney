...
try {
  ...
  [void](Add-ApiCaseResult -Results $results -Name "public-demand-detail-invalid-demand-id-format" -Method "GET" -Url "http://127.0.0.1:$resolvedApiPort/public/demands/not-a-uuid" -Body $null -Headers @{} -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "public-achievement-detail-invalid-achievement-id-format" -Method "GET" -Url "http://127.0.0.1:$resolvedApiPort/public/achievements/not-a-uuid" -Body $null -Headers @{} -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "public-artwork-detail-invalid-artwork-id-format" -Method "GET" -Url "http://127.0.0.1:$resolvedApiPort/public/artworks/not-a-uuid" -Body $null -Headers @{} -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "public-announcement-detail-invalid-announcement-id-format" -Method "GET" -Url "http://127.0.0.1:$resolvedApiPort/public/announcements/not-a-uuid" -Body $null -Headers @{} -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "listing-create-empty-negotiable-note" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/listings" -Body @{ title = "Smoke User Listing Empty Negotiable Note"; negotiableNote = "" } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "listing-create-empty-negotiable-note") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "listing-update-empty-summary" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/listings/$smokeUserListingId" -Body @{ summary = "" } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "listing-update-empty-summary") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "listing-update-empty-negotiable-note" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/listings/$smokeUserListingId" -Body @{ negotiableNote = "" } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "listing-update-empty-negotiable-note") -Expected @(400))
  ...
  $regionIndustryTags = @($newIndustryTagName, $newIndustryTagNameAlt) + @(
    $regionIndustryTags | Where-Object { $_ -ne $newIndustryTagName -and $_ -ne $newIndustryTagNameAlt } | Select-Object -First 1
  )
  ...
  [void](Add-ApiCaseResult -Results $results -Name "admin-announcement-create-empty-title" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/admin/announcements" -Body @{ title = "" } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-announcement-create-empty-title") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "admin-announcement-update-empty-issue-no" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/admin/announcements/$smokeAnnouncementId" -Body @{ issueNo = "" } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-announcement-update-empty-issue-no") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "admin-announcement-update-invalid-announcement-id-format" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/admin/announcements/not-a-uuid" -Body @{ title = "Smoke Announcement Invalid Route Id Format" } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-announcement-update-invalid-announcement-id-format") -Expected @(400))
  ...
  $adminDemandCreate = Add-ApiCaseResult -Results $results -Name "admin-demand-create" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/admin/demands" -Body @{ title = $smokeAdminDemandTitle; source = "ADMIN"; status = "DRAFT"; auditStatus = "PENDING"; budgetType = "FIXED"; budgetMinFen = 1000; budgetMaxFen = 3000; deliveryPeriod = "MONTH_1_3"; industryTags = @($newIndustryTagName, $newIndustryTagNameAlt) } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-demand-create") -Expected @(200, 201)
  ...
  [void](Add-ApiCaseResult -Results $results -Name "admin-demand-get-by-id-invalid-demand-id-format" -Method "GET" -Url "http://127.0.0.1:$resolvedApiPort/admin/demands/not-a-uuid" -Body $null -Headers @{ Authorization = $adminToken } -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "admin-demand-materials-invalid-demand-id-format" -Method "GET" -Url "http://127.0.0.1:$resolvedApiPort/admin/demands/not-a-uuid/materials" -Body $null -Headers @{ Authorization = $adminToken } -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "admin-demand-audit-logs-invalid-demand-id-format" -Method "GET" -Url "http://127.0.0.1:$resolvedApiPort/admin/demands/not-a-uuid/audit-logs" -Body $null -Headers @{ Authorization = $adminToken } -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "demand-get-by-id-invalid-demand-id-format" -Method "GET" -Url "http://127.0.0.1:$resolvedApiPort/demands/not-a-uuid" -Body $null -Headers @{ Authorization = $userToken } -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "admin-demand-create-empty-title" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/admin/demands" -Body @{ title = "" } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-demand-create-empty-title") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "admin-demand-create-empty-summary" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/admin/demands" -Body @{ title = "Smoke Admin Demand Empty Summary"; summary = "" } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-demand-create-empty-summary") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "admin-demand-create-empty-description" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/admin/demands" -Body @{ title = "Smoke Admin Demand Empty Description"; description = "" } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-demand-create-empty-description") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "admin-demand-create-empty-publisher-user-id" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/admin/demands" -Body @{ title = "Smoke Admin Demand Empty Publisher"; publisherUserId = "" } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-demand-create-empty-publisher-user-id") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "admin-demand-create-empty-contact-name" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/admin/demands" -Body @{ title = "Smoke Admin Demand Empty Contact Name"; contactName = "" } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-demand-create-empty-contact-name") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "admin-demand-create-empty-contact-title" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/admin/demands" -Body @{ title = "Smoke Admin Demand Empty Contact Title"; contactTitle = "" } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-demand-create-empty-contact-title") -Expected @(400))
  ...
  $adminDemandUpdate = Add-ApiCaseResult -Results $results -Name "admin-demand-update" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/admin/demands/$smokeAdminDemandId" -Body @{ title = "$smokeAdminDemandTitle Updated"; source = "PLATFORM"; status = "ACTIVE"; auditStatus = "APPROVED"; budgetType = "NEGOTIABLE"; deliveryPeriod = "WITHIN_1_MONTH"; industryTags = @($newIndustryTagName, $newIndustryTagNameAlt) } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-demand-update") -Expected @(200)
  ...
  [void](Add-ApiCaseResult -Results $results -Name "admin-demand-update-invalid-demand-id-format" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/admin/demands/not-a-uuid" -Body @{ title = "smoke invalid demand id format update" } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-demand-update-invalid-demand-id-format") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "admin-demand-update-empty-title" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/admin/demands/$smokeAdminDemandId" -Body @{ title = "" } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-demand-update-empty-title") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "admin-demand-update-null-title" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/admin/demands/$smokeAdminDemandId" -Body @{ title = $null } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-demand-update-null-title") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "admin-demand-update-empty-summary" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/admin/demands/$smokeAdminDemandId" -Body @{ summary = "" } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-demand-update-empty-summary") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "admin-demand-update-empty-description" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/admin/demands/$smokeAdminDemandId" -Body @{ description = "" } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-demand-update-empty-description") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "admin-demand-update-empty-publisher-user-id" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/admin/demands/$smokeAdminDemandId" -Body @{ publisherUserId = "" } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-demand-update-empty-publisher-user-id") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "admin-demand-update-empty-contact-name" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/admin/demands/$smokeAdminDemandId" -Body @{ contactName = "" } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-demand-update-empty-contact-name") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "admin-demand-update-empty-contact-title" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/admin/demands/$smokeAdminDemandId" -Body @{ contactTitle = "" } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-demand-update-empty-contact-title") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "admin-demand-update-empty-contact-phone-masked" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/admin/demands/$smokeAdminDemandId" -Body @{ contactPhoneMasked = "" } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-demand-update-empty-contact-phone-masked") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "admin-demand-off-shelf-invalid-demand-id-format" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/admin/demands/not-a-uuid/off-shelf" -Body @{} -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-demand-off-shelf-invalid-demand-id-format") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "admin-demand-publish-invalid-demand-id-format" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/admin/demands/not-a-uuid/publish" -Body @{} -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-demand-publish-invalid-demand-id-format") -Expected @(400))
  ...
  $publicDemandSearchWithHiddenIndustryFilterAlt = Add-ApiCaseResult -Results $results -Name "public-demand-search-hidden-industry-filter-alt-underscore-ignored" -Method "GET" -Url "http://127.0.0.1:$resolvedApiPort/search/demands?q=$publicDemandSearchQuery&industryTags=$encodedHiddenIndustryTagFilterAlt&page=1&pageSize=20" -Body $null -Headers @{} -Expected @(200)
  Assert-ResultJsonItemsContainsId -Result $publicDemandSearchWithHiddenIndustryFilterAlt -ItemId $smokeAdminDemandId -Assertion "public-demand-search-hidden-industry-filter-alt-item-visible"
  Assert-ResultJsonItemsItemArrayNotContains -Result $publicDemandSearchWithHiddenIndustryFilterAlt -ItemId $smokeAdminDemandId -ArrayField "industryTags" -UnexpectedValue $newIndustryTagNameAlt -Assertion "public-demand-search-hidden-industry-filter-alt-smoke-tag-hidden"
  ...
  [void](Add-ApiCaseResult -Results $results -Name "admin-achievement-get-by-id-invalid-achievement-id-format" -Method "GET" -Url "http://127.0.0.1:$resolvedApiPort/admin/achievements/not-a-uuid" -Body $null -Headers @{ Authorization = $adminToken } -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "admin-achievement-materials-invalid-achievement-id-format" -Method "GET" -Url "http://127.0.0.1:$resolvedApiPort/admin/achievements/not-a-uuid/materials" -Body $null -Headers @{ Authorization = $adminToken } -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "admin-achievement-audit-logs-invalid-achievement-id-format" -Method "GET" -Url "http://127.0.0.1:$resolvedApiPort/admin/achievements/not-a-uuid/audit-logs" -Body $null -Headers @{ Authorization = $adminToken } -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "achievement-get-by-id-invalid-achievement-id-format" -Method "GET" -Url "http://127.0.0.1:$resolvedApiPort/achievements/not-a-uuid" -Body $null -Headers @{ Authorization = $userToken } -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "admin-achievement-create-empty-title" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/admin/achievements" -Body @{ title = "" } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-achievement-create-empty-title") -Expected @(400))
  ...
  $adminAchievementUpdate = Add-ApiCaseResult -Results $results -Name "admin-achievement-update" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/admin/achievements/$smokeAdminAchievementId" -Body @{ title = "$smokeAdminAchievementTitle Updated"; source = "PLATFORM"; status = "ACTIVE"; auditStatus = "APPROVED"; maturity = "PILOT"; industryTags = @($newIndustryTagName, $newIndustryTagNameAlt) } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-achievement-update") -Expected @(200)
  ...
  [void](Add-ApiCaseResult -Results $results -Name "admin-achievement-update-invalid-achievement-id-format" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/admin/achievements/not-a-uuid" -Body @{ title = "smoke invalid achievement id format update" } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-achievement-update-invalid-achievement-id-format") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "admin-achievement-update-empty-title" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/admin/achievements/$smokeAdminAchievementId" -Body @{ title = "" } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-achievement-update-empty-title") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "admin-achievement-update-null-title" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/admin/achievements/$smokeAdminAchievementId" -Body @{ title = $null } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-achievement-update-null-title") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "admin-achievement-update-empty-summary" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/admin/achievements/$smokeAdminAchievementId" -Body @{ summary = "" } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-achievement-update-empty-summary") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "admin-achievement-update-empty-description" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/admin/achievements/$smokeAdminAchievementId" -Body @{ description = "" } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-achievement-update-empty-description") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "admin-achievement-update-empty-publisher-user-id" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/admin/achievements/$smokeAdminAchievementId" -Body @{ publisherUserId = "" } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-achievement-update-empty-publisher-user-id") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "admin-achievement-off-shelf-invalid-achievement-id-format" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/admin/achievements/not-a-uuid/off-shelf" -Body @{} -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-achievement-off-shelf-invalid-achievement-id-format") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "admin-achievement-publish-invalid-achievement-id-format" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/admin/achievements/not-a-uuid/publish" -Body @{} -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-achievement-publish-invalid-achievement-id-format") -Expected @(400))
  ...
  $publicAchievementSearchWithHiddenIndustryFilterAlt = Add-ApiCaseResult -Results $results -Name "public-achievement-search-hidden-industry-filter-alt-underscore-ignored" -Method "GET" -Url "http://127.0.0.1:$resolvedApiPort/search/achievements?q=$publicAchievementSearchQuery&industryTags=$encodedHiddenIndustryTagFilterAlt&page=1&pageSize=20" -Body $null -Headers @{} -Expected @(200)
  Assert-ResultJsonItemsContainsId -Result $publicAchievementSearchWithHiddenIndustryFilterAlt -ItemId $smokeAdminAchievementId -Assertion "public-achievement-search-hidden-industry-filter-alt-item-visible"
  Assert-ResultJsonItemsItemArrayNotContains -Result $publicAchievementSearchWithHiddenIndustryFilterAlt -ItemId $smokeAdminAchievementId -ArrayField "industryTags" -UnexpectedValue $newIndustryTagNameAlt -Assertion "public-achievement-search-hidden-industry-filter-alt-smoke-tag-hidden"
  ...
  [void](Add-ApiCaseResult -Results $results -Name "admin-achievement-reject-invalid-achievement-id-format" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/admin/achievements/not-a-uuid/reject" -Body @{ reason = "smoke invalid achievement id format reject" } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-achievement-reject-invalid-achievement-id-format") -Expected @(400))

  $smokeAdminArtworkTitle = "Smoke Admin Artwork $ReportDate $([guid]::NewGuid().ToString('N').Substring(0, 8))"
  $adminArtworkCreate = Add-ApiCaseResult -Results $results -Name "admin-artwork-create" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/admin/artworks" -Body @{ title = $smokeAdminArtworkTitle; category = "PAINTING"; creatorName = "Smoke Artist"; priceType = "FIXED"; source = "ADMIN"; status = "DRAFT"; auditStatus = "PENDING"; paintingGenre = "LANDSCAPE"; creationYear = 2020; priceAmountFen = 8800 } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-artwork-create") -Expected @(200, 201)
  ...
  [void](Add-ApiCaseResult -Results $results -Name "admin-artwork-get-by-id-invalid-artwork-id-format" -Method "GET" -Url "http://127.0.0.1:$resolvedApiPort/admin/artworks/not-a-uuid" -Body $null -Headers @{ Authorization = $adminToken } -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "admin-artwork-materials-invalid-artwork-id-format" -Method "GET" -Url "http://127.0.0.1:$resolvedApiPort/admin/artworks/not-a-uuid/materials" -Body $null -Headers @{ Authorization = $adminToken } -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "admin-artwork-audit-logs-invalid-artwork-id-format" -Method "GET" -Url "http://127.0.0.1:$resolvedApiPort/admin/artworks/not-a-uuid/audit-logs" -Body $null -Headers @{ Authorization = $adminToken } -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "artwork-get-by-id-invalid-artwork-id-format" -Method "GET" -Url "http://127.0.0.1:$resolvedApiPort/artworks/not-a-uuid" -Body $null -Headers @{ Authorization = $userToken } -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "admin-artwork-create-empty-title" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/admin/artworks" -Body @{ title = ""; category = "PAINTING"; creatorName = "Smoke Artist"; priceType = "FIXED" } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-artwork-create-empty-title") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "admin-artwork-create-empty-creator-name" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/admin/artworks" -Body @{ title = "Smoke Admin Artwork Empty Creator Name"; category = "PAINTING"; creatorName = ""; priceType = "FIXED" } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-artwork-create-empty-creator-name") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "admin-artwork-create-empty-description" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/admin/artworks" -Body @{ title = "Smoke Admin Artwork Empty Description"; category = "PAINTING"; creatorName = "Smoke Artist"; priceType = "FIXED"; description = "" } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-artwork-create-empty-description") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "admin-artwork-create-empty-certificate-no" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/admin/artworks" -Body @{ title = "Smoke Admin Artwork Empty Certificate No"; category = "PAINTING"; creatorName = "Smoke Artist"; priceType = "FIXED"; certificateNo = "" } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-artwork-create-empty-certificate-no") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "admin-artwork-create-empty-material" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/admin/artworks" -Body @{ title = "Smoke Admin Artwork Empty Material"; category = "PAINTING"; creatorName = "Smoke Artist"; priceType = "FIXED"; material = "" } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-artwork-create-empty-material") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "admin-artwork-create-empty-size" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/admin/artworks" -Body @{ title = "Smoke Admin Artwork Empty Size"; category = "PAINTING"; creatorName = "Smoke Artist"; priceType = "FIXED"; size = "" } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-artwork-create-empty-size") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "admin-artwork-create-empty-seller-user-id" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/admin/artworks" -Body @{ title = "Smoke Admin Artwork Empty Seller"; category = "PAINTING"; creatorName = "Smoke Artist"; priceType = "FIXED"; sellerUserId = "" } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-artwork-create-empty-seller-user-id") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "admin-artwork-update-invalid-artwork-id-format" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/admin/artworks/not-a-uuid" -Body @{ title = "smoke invalid artwork id format update" } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-artwork-update-invalid-artwork-id-format") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "admin-artwork-update-empty-title" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/admin/artworks/$smokeAdminArtworkId" -Body @{ title = "" } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-artwork-update-empty-title") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "admin-artwork-update-null-title" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/admin/artworks/$smokeAdminArtworkId" -Body @{ title = $null } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-artwork-update-null-title") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "admin-artwork-update-empty-creator-name" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/admin/artworks/$smokeAdminArtworkId" -Body @{ creatorName = "" } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-artwork-update-empty-creator-name") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "admin-artwork-update-null-creator-name" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/admin/artworks/$smokeAdminArtworkId" -Body @{ creatorName = $null } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-artwork-update-null-creator-name") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "admin-artwork-update-empty-description" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/admin/artworks/$smokeAdminArtworkId" -Body @{ description = "" } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-artwork-update-empty-description") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "admin-artwork-update-empty-certificate-no" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/admin/artworks/$smokeAdminArtworkId" -Body @{ certificateNo = "" } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-artwork-update-empty-certificate-no") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "admin-artwork-update-empty-material" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/admin/artworks/$smokeAdminArtworkId" -Body @{ material = "" } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-artwork-update-empty-material") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "admin-artwork-update-empty-size" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/admin/artworks/$smokeAdminArtworkId" -Body @{ size = "" } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-artwork-update-empty-size") -Expected @(400))
  ...
  Assert-ResultJsonFieldEquals -Result $adminArtworkUpdateClearNullRegionCode -Field "creationYear" -ExpectedValue 2020 -Assertion "admin-artwork-update-omitted-creation-year-preserved"
  Assert-ResultJsonFieldEquals -Result $adminArtworkUpdateClearNullRegionCode -Field "priceAmountFen" -ExpectedValue 8800 -Assertion "admin-artwork-update-omitted-price-amount-preserved"
  ...
  [void](Add-ApiCaseResult -Results $results -Name "admin-artwork-update-empty-seller-user-id" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/admin/artworks/$smokeAdminArtworkId" -Body @{ sellerUserId = "" } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-artwork-update-empty-seller-user-id") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "admin-artwork-off-shelf-invalid-artwork-id-format" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/admin/artworks/not-a-uuid/off-shelf" -Body @{} -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-artwork-off-shelf-invalid-artwork-id-format") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "admin-artwork-publish-invalid-artwork-id-format" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/admin/artworks/not-a-uuid/publish" -Body @{} -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-artwork-publish-invalid-artwork-id-format") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "admin-artwork-approve-invalid-artwork-id-format" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/admin/artworks/not-a-uuid/approve" -Body @{} -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-artwork-approve-invalid-artwork-id-format") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "admin-artwork-reject-invalid-artwork-id-format" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/admin/artworks/not-a-uuid/reject" -Body @{ reason = "smoke invalid artwork id format reject" } -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-artwork-reject-invalid-artwork-id-format") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "admin-announcement-publish-invalid-announcement-id-format" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/admin/announcements/not-a-uuid/publish" -Body @{} -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-announcement-publish-invalid-announcement-id-format") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "admin-announcement-off-shelf-invalid-announcement-id-format" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/admin/announcements/not-a-uuid/off-shelf" -Body @{} -Headers (New-WriteHeaders -AuthorizationToken $adminToken -Prefix $idempotencyPrefix -Label "admin-announcement-off-shelf-invalid-announcement-id-format") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "demand-create-empty-summary" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/demands" -Body @{ title = "Smoke Demand Empty Summary"; summary = "" } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "demand-create-empty-summary") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "demand-create-empty-description" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/demands" -Body @{ title = "Smoke Demand Empty Description"; description = "" } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "demand-create-empty-description") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "demand-create-empty-contact-name" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/demands" -Body @{ title = "Smoke Demand Empty Contact Name"; contactName = "" } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "demand-create-empty-contact-name") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "demand-create-empty-contact-title" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/demands" -Body @{ title = "Smoke Demand Empty Contact Title"; contactTitle = "" } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "demand-create-empty-contact-title") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "demand-create-empty-contact-phone-masked" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/demands" -Body @{ title = "Smoke Demand Empty Contact Phone"; contactPhoneMasked = "" } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "demand-create-empty-contact-phone-masked") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "demand-update-empty-title" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/demands/$userDemandForUpdateId" -Body @{ title = "" } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "demand-update-empty-title") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "demand-update-null-title" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/demands/$userDemandForUpdateId" -Body @{ title = $null } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "demand-update-null-title") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "demand-update-empty-summary" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/demands/$userDemandForUpdateId" -Body @{ summary = "" } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "demand-update-empty-summary") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "demand-update-empty-description" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/demands/$userDemandForUpdateId" -Body @{ description = "" } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "demand-update-empty-description") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "demand-update-empty-contact-name" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/demands/$userDemandForUpdateId" -Body @{ contactName = "" } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "demand-update-empty-contact-name") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "demand-update-empty-contact-title" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/demands/$userDemandForUpdateId" -Body @{ contactTitle = "" } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "demand-update-empty-contact-title") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "demand-update-empty-contact-phone-masked" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/demands/$userDemandForUpdateId" -Body @{ contactPhoneMasked = "" } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "demand-update-empty-contact-phone-masked") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "demand-get-mine-invalid-demand-id-format" -Method "GET" -Url "http://127.0.0.1:$resolvedApiPort/demands/not-a-uuid" -Body $null -Headers @{ Authorization = $userToken } -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "demand-update-invalid-demand-id-format" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/demands/not-a-uuid" -Body @{ title = "smoke invalid demand id format update" } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "demand-update-invalid-demand-id-format") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "demand-submit-invalid-demand-id-format" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/demands/not-a-uuid/submit" -Body @{} -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "demand-submit-invalid-demand-id-format") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "demand-off-shelf-invalid-demand-id-format" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/demands/not-a-uuid/off-shelf" -Body @{} -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "demand-off-shelf-invalid-demand-id-format") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "demand-create-empty-title" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/demands" -Body @{ title = "" } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "demand-create-empty-title") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "achievement-create-empty-summary" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/achievements" -Body @{ title = "Smoke Achievement Empty Summary"; summary = "" } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "achievement-create-empty-summary") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "achievement-create-empty-description" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/achievements" -Body @{ title = "Smoke Achievement Empty Description"; description = "" } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "achievement-create-empty-description") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "achievement-update-empty-title" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/achievements/$userAchievementForUpdateId" -Body @{ title = "" } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "achievement-update-empty-title") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "achievement-update-null-title" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/achievements/$userAchievementForUpdateId" -Body @{ title = $null } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "achievement-update-null-title") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "achievement-update-empty-summary" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/achievements/$userAchievementForUpdateId" -Body @{ summary = "" } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "achievement-update-empty-summary") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "achievement-update-empty-description" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/achievements/$userAchievementForUpdateId" -Body @{ description = "" } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "achievement-update-empty-description") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "achievement-create-empty-title" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/achievements" -Body @{ title = "" } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "achievement-create-empty-title") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "achievement-get-mine-invalid-achievement-id-format" -Method "GET" -Url "http://127.0.0.1:$resolvedApiPort/achievements/not-a-uuid" -Body $null -Headers @{ Authorization = $userToken } -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "achievement-update-invalid-achievement-id-format" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/achievements/not-a-uuid" -Body @{ title = "smoke invalid achievement id format update" } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "achievement-update-invalid-achievement-id-format") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "achievement-submit-invalid-achievement-id-format" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/achievements/not-a-uuid/submit" -Body @{} -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "achievement-submit-invalid-achievement-id-format") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "achievement-off-shelf-invalid-achievement-id-format" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/achievements/not-a-uuid/off-shelf" -Body @{} -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "achievement-off-shelf-invalid-achievement-id-format") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "artwork-create-empty-title" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/artworks" -Body @{ title = ""; category = "PAINTING"; creatorName = "Smoke Artist"; priceType = "FIXED" } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "artwork-create-empty-title") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "artwork-create-empty-creator-name" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/artworks" -Body @{ title = "Smoke Artwork Empty Creator Name"; category = "PAINTING"; creatorName = ""; priceType = "FIXED" } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "artwork-create-empty-creator-name") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "artwork-create-empty-description" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/artworks" -Body @{ title = "Smoke Artwork Empty Description"; category = "PAINTING"; creatorName = "Smoke Artist"; priceType = "FIXED"; description = "" } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "artwork-create-empty-description") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "artwork-create-empty-certificate-no" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/artworks" -Body @{ title = "Smoke Artwork Empty Certificate No"; category = "PAINTING"; creatorName = "Smoke Artist"; priceType = "FIXED"; certificateNo = "" } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "artwork-create-empty-certificate-no") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "artwork-create-empty-material" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/artworks" -Body @{ title = "Smoke Artwork Empty Material"; category = "PAINTING"; creatorName = "Smoke Artist"; priceType = "FIXED"; material = "" } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "artwork-create-empty-material") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "artwork-create-empty-size" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/artworks" -Body @{ title = "Smoke Artwork Empty Size"; category = "PAINTING"; creatorName = "Smoke Artist"; priceType = "FIXED"; size = "" } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "artwork-create-empty-size") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "artwork-update-empty-title" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/artworks/$userArtworkForUpdateId" -Body @{ title = "" } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "artwork-update-empty-title") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "artwork-update-null-title" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/artworks/$userArtworkForUpdateId" -Body @{ title = $null } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "artwork-update-null-title") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "artwork-update-empty-creator-name" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/artworks/$userArtworkForUpdateId" -Body @{ creatorName = "" } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "artwork-update-empty-creator-name") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "artwork-update-null-creator-name" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/artworks/$userArtworkForUpdateId" -Body @{ creatorName = $null } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "artwork-update-null-creator-name") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "artwork-update-empty-description" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/artworks/$userArtworkForUpdateId" -Body @{ description = "" } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "artwork-update-empty-description") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "artwork-update-empty-certificate-no" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/artworks/$userArtworkForUpdateId" -Body @{ certificateNo = "" } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "artwork-update-empty-certificate-no") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "artwork-update-empty-material" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/artworks/$userArtworkForUpdateId" -Body @{ material = "" } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "artwork-update-empty-material") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "artwork-update-empty-size" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/artworks/$userArtworkForUpdateId" -Body @{ size = "" } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "artwork-update-empty-size") -Expected @(400))
  ...
  Assert-ResultJsonFieldEquals -Result $artworkUpdateClearNullRegionCode -Field "creationYear" -ExpectedValue 2021 -Assertion "artwork-update-omitted-creation-year-preserved"
  Assert-ResultJsonFieldEquals -Result $artworkUpdateClearNullRegionCode -Field "priceAmountFen" -ExpectedValue 6600 -Assertion "artwork-update-omitted-price-amount-preserved"
  ...
  [void](Add-ApiCaseResult -Results $results -Name "artwork-get-mine-invalid-artwork-id-format" -Method "GET" -Url "http://127.0.0.1:$resolvedApiPort/artworks/not-a-uuid" -Body $null -Headers @{ Authorization = $userToken } -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "artwork-update-invalid-artwork-id-format" -Method "PATCH" -Url "http://127.0.0.1:$resolvedApiPort/artworks/not-a-uuid" -Body @{ title = "smoke invalid artwork id format update" } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "artwork-update-invalid-artwork-id-format") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "artwork-submit-invalid-artwork-id-format" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/artworks/not-a-uuid/submit" -Body @{} -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "artwork-submit-invalid-artwork-id-format") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "artwork-off-shelf-invalid-artwork-id-format" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/artworks/not-a-uuid/off-shelf" -Body @{} -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "artwork-off-shelf-invalid-artwork-id-format") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "demand-favorite-post-invalid-demand-id-format" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/demands/not-a-uuid/favorites" -Body $null -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "favorite-demand-post-invalid-demand-id-format") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "demand-favorite-delete-invalid-demand-id-format" -Method "DELETE" -Url "http://127.0.0.1:$resolvedApiPort/demands/not-a-uuid/favorites" -Body $null -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "favorite-demand-delete-invalid-demand-id-format") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "achievement-favorite-post-invalid-achievement-id-format" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/achievements/not-a-uuid/favorites" -Body $null -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "favorite-achievement-post-invalid-achievement-id-format") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "achievement-favorite-delete-invalid-achievement-id-format" -Method "DELETE" -Url "http://127.0.0.1:$resolvedApiPort/achievements/not-a-uuid/favorites" -Body $null -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "favorite-achievement-delete-invalid-achievement-id-format") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "artwork-favorite-post-invalid-artwork-id-format" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/artworks/not-a-uuid/favorites" -Body $null -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "favorite-artwork-post-invalid-artwork-id-format") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "artwork-favorite-delete-invalid-artwork-id-format" -Method "DELETE" -Url "http://127.0.0.1:$resolvedApiPort/artworks/not-a-uuid/favorites" -Body $null -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "favorite-artwork-delete-invalid-artwork-id-format") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "order-invoice-get-invalid-order-id-format" -Method "GET" -Url "http://127.0.0.1:$resolvedApiPort/orders/not-a-uuid/invoice" -Body $null -Headers @{ Authorization = $userToken } -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "order-invoice-request-invalid-order-id-format" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/orders/not-a-uuid/invoice-requests" -Body @{} -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "order-invoice-request-invalid-order-id-format") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "order-detail-invalid-order-id-format" -Method "GET" -Url "http://127.0.0.1:$resolvedApiPort/orders/not-a-uuid" -Body $null -Headers @{ Authorization = $userToken } -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "order-payment-intent-invalid-order-id-format" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/orders/not-a-uuid/payment-intents" -Body @{ payType = "DEPOSIT" } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "order-payment-intent-invalid-order-id-format") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "order-case-invalid-order-id-format" -Method "GET" -Url "http://127.0.0.1:$resolvedApiPort/orders/not-a-uuid/case" -Body $null -Headers @{ Authorization = $userToken } -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "order-refund-requests-list-invalid-order-id-format" -Method "GET" -Url "http://127.0.0.1:$resolvedApiPort/orders/not-a-uuid/refund-requests" -Body $null -Headers @{ Authorization = $userToken } -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "order-refund-request-invalid-order-id-format" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/orders/not-a-uuid/refund-requests" -Body @{ reasonCode = "OTHER"; reasonText = "smoke invalid orderId format" } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "order-refund-request-invalid-order-id-format") -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "order-create-invalid-listing-id-format" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/orders" -Body @{ listingId = "not-a-uuid" } -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "order-create-invalid-listing-id-format") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "contract-list-invalid-page-negative" -Method "GET" -Url "http://127.0.0.1:$resolvedApiPort/contracts?page=-1" -Body $null -Headers @{ Authorization = $userToken } -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "contract-list-invalid-page-size-negative" -Method "GET" -Url "http://127.0.0.1:$resolvedApiPort/contracts?pageSize=-1" -Body $null -Headers @{ Authorization = $userToken } -Expected @(400))
  [void](Add-ApiCaseResult -Results $results -Name "contract-list-invalid-page-decimal" -Method "GET" -Url "http://127.0.0.1:$resolvedApiPort/contracts?page=1.5" -Body $null -Headers @{ Authorization = $userToken } -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "contract-list-invalid-page-size-decimal" -Method "GET" -Url "http://127.0.0.1:$resolvedApiPort/contracts?pageSize=1.5" -Body $null -Headers @{ Authorization = $userToken } -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "contract-list-page-one" -Method "GET" -Url "http://127.0.0.1:$resolvedApiPort/contracts?page=1" -Body $null -Headers @{ Authorization = $userToken } -Expected @(200))
  $contractListPageSizeOne = Add-ApiCaseResult -Results $results -Name "contract-list-page-size-one" -Method "GET" -Url "http://127.0.0.1:$resolvedApiPort/contracts?pageSize=1" -Body $null -Headers @{ Authorization = $userToken } -Expected @(200)
  ...
  $contractListPageOnePageSizeFifty = Add-ApiCaseResult -Results $results -Name "contract-list-page-one-page-size-fifty" -Method "GET" -Url "http://127.0.0.1:$resolvedApiPort/contracts?page=1&pageSize=50" -Body $null -Headers @{ Authorization = $userToken } -Expected @(200)
  ...
  $contractListWaitConfirmLowercase = Add-ApiCaseResult -Results $results -Name "contract-list-wait-confirm-lowercase" -Method "GET" -Url "http://127.0.0.1:$resolvedApiPort/contracts?status=wait_confirm" -Body $null -Headers @{ Authorization = $userToken } -Expected @(200)
  ...
  [void](Add-ApiCaseResult -Results $results -Name "demand-conversation-upsert-invalid-demand-id-format" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/demands/not-a-uuid/conversations" -Body $null -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "demand-conversation-upsert-invalid-demand-id-format") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "achievement-conversation-upsert-invalid-achievement-id-format" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/achievements/not-a-uuid/conversations" -Body $null -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "achievement-conversation-upsert-invalid-achievement-id-format") -Expected @(400))
  ...
  [void](Add-ApiCaseResult -Results $results -Name "artwork-conversation-upsert-invalid-artwork-id-format" -Method "POST" -Url "http://127.0.0.1:$resolvedApiPort/artworks/not-a-uuid/conversations" -Body $null -Headers (New-WriteHeaders -AuthorizationToken $userToken -Prefix $idempotencyPrefix -Label "artwork-conversation-upsert-invalid-artwork-id-format") -Expected @(400))
