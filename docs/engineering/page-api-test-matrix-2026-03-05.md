...
- DOM assertion automation: 36/83 pages (36/36 in current DOM smoke run).
...
- DOM smoke is running in `full-batch1` and currently covers 36/83 pages; continue expanding toward full 83-page assertions.
