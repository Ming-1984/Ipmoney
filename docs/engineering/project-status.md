...
- 内容模块：listings、achievements、专利地图、机构、技术经理人、公告、通知。

## 已完成（基线）
### 客户端（小程序 + H5）
- 登录/身份引导/认证提交；头像与昵称更新。
- 搜索 + 筛选 + 详情（专利/成果）与统一状态机。
- 发布链路（专利/成果）。
- 订单与支付页面（H5 引导回小程序支付）。
- 订单开票申请入口（订单详情）。
- 收藏、消息/聊天、通知、公告。
...
- 内容模块：achievements/announcements/notifications/organizations/tech-managers/inventors。
