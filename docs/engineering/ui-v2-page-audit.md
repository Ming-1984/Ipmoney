...
- P0：快捷入口固定为 **5 个一排**（发明人榜/专利地图/书画专区/产学研需求/成果转化），移除“技术经理人”（由 TabBar「咨询」承载）
- P0：公告区仅保留“公告滚动条”（无标题/无全部按钮），默认最新 3 条；点击任意条进入公告列表页
- P0：特色专区为 2×2 海报卡（左文案 + 右插画 + 角标 NEW），保持与全局 token（圆角/阴影/字号）一致
