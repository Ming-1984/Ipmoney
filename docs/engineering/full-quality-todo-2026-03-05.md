...
- `smoke`: pass (API 1220/1220, UI HTTP 86/86, UI Render full 83/83, UI Render core 3/3, UI DOM core 11/11, UI DOM full-83 83/83).
...
- API smoke covers 1220 checks (including semantic read-back/state assertions).
...
| B04 | done | Codex | 2026-03-06 | 2026-03-08 | `api-real-smoke` expanded to 1220/1220 (writes 902/902 + reads 318/318 including 93 semantic read-back assertions), with unique write-operation coverage already near-full baseline |
