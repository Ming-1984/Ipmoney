...
- `smoke`: pass (API 1479/1479, UI HTTP 86/86, UI Render full 83/83, UI Render core 3/3, UI DOM full-83 83/83, UI DOM core 11/11).
...
- API smoke covers 1479 checks (including semantic read-back/state assertions).
...
| B04 | done | Codex | 2026-03-06 | 2026-03-09 | `api-real-smoke` expanded to 1479/1479 (writes 1118/1118 + reads 361/361 including 106 semantic read-back assertions), with unique write-operation coverage already near-full baseline |
