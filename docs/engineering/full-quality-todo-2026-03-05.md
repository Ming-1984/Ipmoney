...
- `smoke`: pass (API 780/780, UI HTTP 28/28, UI Render full 83/83, UI Render core 3/3, UI DOM core 11/11, UI DOM full-83 83/83).
...
- API smoke covers 780 checks (including semantic read-back/state assertions).
...
| B04 | done | Codex | 2026-03-06 | 2026-03-07 | `api-real-smoke` expanded to 780/780 (writes 559/559 + reads 221/221 including 93 semantic read-back assertions), with unique write-operation coverage already near-full baseline |
...
- Deliverables:
  1) `api-real-smoke` expanded from 17 to 780 checks (done),
