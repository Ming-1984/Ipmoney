...
- `smoke`: pass (API 803/803, UI HTTP 28/28, UI Render full 83/83, UI Render core 3/3, UI DOM core 11/11, UI DOM full-83 83/83).
...
- API smoke covers 803 checks (including semantic read-back/state assertions).
...
| B04 | done | Codex | 2026-03-06 | 2026-03-07 | `api-real-smoke` expanded to 803/803 (writes 565/565 + reads 238/238 including 93 semantic read-back assertions), with unique write-operation coverage already near-full baseline |
...
- Deliverables:
  1) `api-real-smoke` expanded from 17 to 803 checks (done),
