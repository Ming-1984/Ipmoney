...
- `smoke`: pass (API 737/737, UI HTTP 28/28, UI Render full 83/83, UI Render core 3/3, UI DOM core 11/11, UI DOM full-83 83/83).
...
- API smoke covers 737 checks (including semantic read-back/state assertions).
...
| B04 | done | Codex | 2026-03-06 | 2026-03-06 | `api-real-smoke` expanded to 737/737 (writes 559/559 + reads 178/178 including 93 semantic read-back assertions), with unique write-operation coverage already near-full baseline |
