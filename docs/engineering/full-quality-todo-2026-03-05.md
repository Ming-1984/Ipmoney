...
- Deliverables:
  1) `api-real-smoke` expanded from 17 to 1161 checks (done),
  ...
  49) next step: carry trend history across daily/CI runs and calibrate threshold factors using broader variance data (pending).
