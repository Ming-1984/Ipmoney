...
- `smoke`: pass (API 1385/1385, UI HTTP 86/86, UI Render full 83/83, UI Render core 3/3, UI DOM full-83 83/83, UI DOM core 11/11).
...
- API smoke covers 1385 checks (including semantic read-back/state assertions).
