...
- `smoke`: pass (API 1305/1305, UI HTTP 86/86, UI Render full 83/83, UI Render core 3/3, UI DOM core 11/11, UI DOM full-83 83/83).
...
- API smoke covers 1305 checks (including semantic read-back/state assertions).
