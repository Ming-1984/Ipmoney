...
- `smoke`: pass (API 1402/1402, UI HTTP 86/86, UI Render full 83/83, UI Render core 3/3, UI DOM full-83 83/83, UI DOM core 11/11).
...
- API smoke covers 1402 checks (including semantic read-back/state assertions).
...
| B04 | done | Codex | 2026-03-06 | 2026-03-08 | `api-real-smoke` expanded to 1402/1402 (writes 1042/1042 + reads 360/360 including 106 semantic read-back assertions), with unique write-operation coverage already near-full baseline |
