...
- `smoke`: pass (API 1433/1433, UI HTTP 86/86, UI Render full 83/83, UI Render core 3/3, UI DOM full-83 83/83, UI DOM core 11/11).
- `verify`: pass on 2026-03-08 (now includes `api-smoke-openapi-coverage` + `api-smoke-quality-floor` + `ui-dom-smoke(core)` in pipeline); port/process hardening has been applied to core smoke scripts.
...
- API smoke covers 1433 checks (including semantic read-back/state assertions).
...
| B04 | done | Codex | 2026-03-06 | 2026-03-08 | `api-real-smoke` expanded to 1433/1433 (writes 1072/1072 + reads 361/361 including 106 semantic read-back assertions), with unique write-operation coverage already near-full baseline |
