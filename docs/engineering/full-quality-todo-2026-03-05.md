...
- `smoke`: pass (API 1417/1417, UI HTTP 86/86, UI Render full 83/83, UI Render core 3/3, UI DOM full-83 83/83, UI DOM core 11/11).
...
| B04 | done | Codex | 2026-03-06 | 2026-03-08 | `api-real-smoke` expanded to 1417/1417 (writes 1057/1057 + reads 360/360 including 106 semantic read-back assertions), with unique write-operation coverage already near-full baseline |
