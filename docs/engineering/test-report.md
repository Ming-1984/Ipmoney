...
- `powershell -ExecutionPolicy Bypass -File scripts/verify.ps1 -ReportDate 2026-03-13-r227`
  - Result: success (all steps)
  - Render artifact: `docs/demo/rendered/ui-smoke-2026-03-13-r227/` (core mode, 3 pages)
...
- `pnpm -C apps/api test`
  - Result: pass (`462/462`)
  - Coverage in this batch: existing domain strictness suites remained green, and tech-manager update/public behavior coverage expanded with `test/tech-managers.update-admin.spec.ts` (`5`).
  - Notes: this batch strengthens tech-manager public-detail/admin-update validation branches without touching real login/payment integrations.
