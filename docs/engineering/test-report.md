...
- `powershell -ExecutionPolicy Bypass -File scripts/verify.ps1 -ReportDate 2026-03-14-r249`
  - Result: success (all steps)
  - Render artifact: `docs/demo/rendered/ui-smoke-2026-03-14-r249/` (core mode, 3 pages)
...
- `powershell -ExecutionPolicy Bypass -File scripts/ui-dom-smoke.ps1 -Mode full -ReportDate 2026-03-14-r249`
  - Result: pass (`83/83`, mode=`full-83`)
  - Artifact: `.tmp/ui-dom-smoke-2026-03-14-r249-summary.json`
  - Notes: one earlier run (`r248`) hit transient CDP network errors on 2 detail pages; targeted recheck passed (`2/2`), and full rerun `r249` is stable green.
