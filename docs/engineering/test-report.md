...
- `powershell -ExecutionPolicy Bypass -File scripts/verify.ps1 -ReportDate 2026-03-13-r226`
  - Result: success (all steps)
  - Render artifact: `docs/demo/rendered/ui-smoke-2026-03-13-r226/` (core mode, 3 pages)
...
- `pnpm -C apps/api test`
  - Result: pass (`457/457`)
  - Coverage in this batch: existing domain strictness suites remained green, and contract upload behavior coverage expanded with `test/contracts.upload.spec.ts` (`7`).
  - Notes: this batch strengthens contract upload validation and upsert branches without touching real login/payment integrations.
